...
//// Analog Pins
#define TF_EDGE_LEFT 0
#define TF_EDGE_RIGHT 1
#define TF_FAR_LEFT 2
#define TF_CLOSE_LEFT 3
#define TF_CLOSE_RIGHT 4
#define TF_FAR_RIGHT 5
...
//// Analog Pins
#define L_CLAW_DETECT 0
#define R_CLAW_DETECT 1
